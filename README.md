...
* Выбрал метрики для оценки результатов прошедшего тематического события игры и выдвинул свои предположения, как поменяются метрики, если усложнить механику событий так, что при каждой неудачной попытке выполнения уровня
